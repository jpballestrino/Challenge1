...
class amazon_cart(unittest.TestCase):
    ...
    def test_001_buy_2_iphones_silver_256GB(self):
        ...
        time.sleep(2)
        self.driver.find_element(By.XPATH, value="/html/body/div[1]/div[2]/div[10]/div[6]/div[1]/div[4]/div/div/div[1]/div/div/div[1]/div/div[2]/div/form/div/div/div[5]/div/div/span/div/div/span/span/span").click()
        self.driver.find_element(By.ID, value='quantity_1').click()  # SELECT 2
        time.sleep(2)
